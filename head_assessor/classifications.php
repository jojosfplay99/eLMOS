...
<?php include 'navbar.php'?>
    <div class="container-fluid">
        <section>
            <div class="card">                
                <div class="card-body">
                    <h2 class="text-center mb-3" style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">LAND SETTINGS</h2>
...
<?php include 'classification/modal.php'?>
<?php include 'classification/modal2.php'?>
<?php include 'classification/script.php'?>
<?php include 'classification/script2.php'?>
</html>