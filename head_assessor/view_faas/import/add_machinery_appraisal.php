...
mysqli_query($con,"INSERT INTO machine_appraisal (faasid, propertyid, kind_of_machine, brand, model, capacity_hp, date_acquired, condition_acquired, estimated_life, remaining_life, year_installed, year_initial_operation, original_cost, conversion_factor, no_of_units, rcn, rate_of_depreciation, percentage_depreciation, value_depreciation, total_value_depreciation, date_created) VALUES ('$faasid', '$propertyid', '$kind_of_machine', '$brand','$model', '$capacity', '$date_acquired', '$condition_acquired', '$estimated_life', '$remaining_life', '$year_installed', '$year_initial_operation', '$original_cost', '$conversion_factor', '$no_of_units', '$rcn', '$rate_of_depreciation','$percentage_depreciation', '$value_depreciation', '$total_value_depreciation', '$date_created')") or die(mysqli_error($con));
