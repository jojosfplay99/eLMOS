...
$(document).ready(function(){
    ...
    var table2 = new DataTable('#example2', {                        
        ajax: 'classification3/server2.php',
        processing: true,
        serverSide: false,         
        order:[0,'asc'],
        columnDefs: [
            ...
            {              
                ...
                action: function ( e, dt, node, config ){
                    ...
                    $('#submit_new_actual').on('submit', function(e){
                        ...
                        $.ajax({
                            method: "POST",
                            url: "classification3/add_actual.php",            
                            data:$(this).serialize(),
                        ...
                        action: function ( e, dt, node, config ){
                            ...
                            function setClassCode2(total_length,counter,values,classname){  
                                if(counter < total_length){
                                    ...
                                    $.ajax({
                                        method: "POST",
                                        url: "classification3/set_classification2.php",            
    ...
    $('#example2 tbody').on('click', '.btn-primary', function(){
        ...
        $('#submit_edit_actual').on('submit', function(e){
            ...
            $.ajax({
                method: "POST",
                url: "classification3/edit_actual.php",            
                data:$(this).serialize(),
                success: function(data) {  
                    Swal.fire({
                        icon:'success',
    ...
    $('#example2 tbody').on('click', '.btn-danger', function(){
        ...
        if (result.isConfirmed) {
            $.ajax({
                method: "POST",
                url: "classification3/delete_actualuse.php",            
                data:{id:data[0]},
                success: function(data) { 
                    Swal.fire({
                        icon:'success',
