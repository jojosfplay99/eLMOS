...
mysqli_query($con,"UPDATE machineriesclasses SET code = '$code', general_class = '$classification', description = '$description', value = '$value', status = '$status' WHERE machineriesClassesID = '$id'");
