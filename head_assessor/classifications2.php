...
<?php include 'navbar.php'?>
    <div class="container-fluid">
        <section>
            <div class="card">                
                <div class="card-body">
                    <h2 class="text-center mb-3" style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">BUILDING SETTINGS</h2>
...
<?php include 'classification2/modal.php'?>
<?php include 'classification2/modal2.php'?>
<?php include 'classification2/script.php'?>
<?php include 'classification2/script2.php'?>
</html>