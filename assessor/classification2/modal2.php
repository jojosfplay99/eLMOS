    ...
    <div class="modal-content">
      ...
      <div class="modal-body">  
        ...
        <div class="row">
          <div class="col">
            <div class="form-floating mb-3">
              <input type="number" class="form-control" id="add_actual_lowrange" name="rangeLowerBound" placeholder="name@example.com">
              <label for="floatingInput">Lower Range</label>
            </div>
          </div>
          <div class="col">
            <div class="form-floating mb-3">
              <input type="number" class="form-control" id="add_actual_uprange" name="rangeUpperBound" placeholder="name@example.com">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col">
            <div class="form-floating mb-3">
              <input type="number" class="form-control" id="edit_actual_lowrange" name="rangeLowerBound" placeholder="name@example.com">
              <label for="floatingInput">Lower Range</label>
            </div>
          </div>
          <div class="col">
            <div class="form-floating mb-3">
              <input type="number" class="form-control" id="edit_actual_uprange" name="rangeUpperBound" placeholder="name@example.com">
              <label for="floatingInput">Upper Range</label>
            </div>
          </div>
        </div>
