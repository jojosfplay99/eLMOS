...
<?php include 'navbar.php'?>
    <div class="container-fluid">
        <section>
            <div class="card">                
                <div class="card-body">
                    <h2 class="text-center mb-3" style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">BARANGAY SETTINGS</h2>
...
<?php include 'barangay/modal.php'?>
<?php include 'barangay/script.php'?>
</html>