      ...
      <form id="add_new_faas">  
        <div class="card shadow-lg p-3 mb-5 bg-body-tertiary rounded">
          <div class="card-body">
            ...
            <div class="form-floating mb-3">
              <select class="form-select" id="propertykind" name="propertykind" aria-label="Floating label select example" >
        ...
        <form>
          <div class="card mb-5 shadow-lg p-3 mb-5 bg-body-tertiary rounded" id="land_reference_div" style="width:100%;">
            <div class="card-body">
              ...
              <div class="form-floating mb-3">
                <select class="js-example-basic-single form-control form-select-lg" id="select_building1" name="select_building1" disabled>
