...
<html lang="en" data-bs-theme="auto">
  <head>    
    ...
    <script src="taxdec_active/datatable.js?timestamp=<?php echo date('ymdhis')?>"></script>    
    <script src="taxdec_active/additional_function.js?timestamp=<?php echo date('ymdhis')?>"></script>    
    <style>
      .header1{
  ...
  <body>     
    ...
    <?php include 'taxdec_active/modal.php'?>
    <!------------CONTENT----------->
      <main class="container-fluid">
        <section class="shadow-lg p-3 mb-5 bg-body-tertiary rounded">
          <h2 class="text-center mb-3" style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">ACTIVE TAX DECLARATION</h2>
          <br>
