...
$(document).ready(function(){
    ...
    var table1 = new DataTable('#example', {                        
        ajax: 'classification/server1.php',
        processing: true,
        serverSide: false,         
        order:[0,'asc'],
        columnDefs: [
            ...
            {              
                ...
                action: function ( e, dt, node, config ){
                    ...
                    $('#submit_new_subclass').on('submit', function(e){
                        ...
                        $.ajax({
                            method: "POST",
                            url: "classification/add_subclass.php",            
                            data:$(this).serialize(),
                        ...
                        action: function ( e, dt, node, config ){
                            ...
                            function setClassCode(total_length,counter,values,classname){  
                                if(counter < total_length){
                                    ...
                                    $.ajax({
                                        method: "POST",
                                        url: "classification/set_classification.php",            
    ...
    $('#example tbody').on('click', '.btn-primary', function(){
        ...
        $('#edit_subclass_value').val(data[5])
        $('#edit_subclass_status').val(data[6])
        ...
        $('#submit_edit_subclass').on('submit', function(e){
            ...
            $.ajax({
                method: "POST",
                url: "classification/edit_subclass.php",            
                data:$(this).serialize(),
                success: function(data) {  
                    Swal.fire({
                        icon:'success',
    ...
    $('#example tbody').on('click', '.btn-danger', function(){
        ...
        if (result.isConfirmed) {
            $.ajax({
                method: "POST",
                url: "classification/delete_subclass.php",            
                data:{id:data[0]},
                success: function(data) { 
                    Swal.fire({
                        icon:'success',
