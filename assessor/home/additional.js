$(document).ready(function(){
    ...
    var table1 = new DataTable('#que_table', {                        
        ...
        columnDefs: [
            ...
            },   
            {
                targets: 4,
                data: null,
                defaultContent: '<button class="btn btn-primary btn-sm mb-1 mx-1"><i class="fa-solid fa-check"></i></button>',
            },                                            
        ],
        dom: 'Blfrtip',               
        buttons: [ 
    ...
    $('#que_table tbody').on('click', '.btn-primary', function () {
                                ...
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        $.ajax({
                                            ...
                                            data:{id:que_id,clerkid:cookie_id},
                                            success: function (data) {                        
                                                Swal.fire({
                                                    icon: "success",
                                                    title: "Success!",
