...
<html lang="en" data-bs-theme="auto">
  <head>    
    ...
    <script src="taxdec_pending/datatable.js?timestamp=<?php echo date('ymdhis')?>"></script>    
  
    <!-- Custom styles for this template -->
  </head>
  <body>     
    <?php include 'navbar.php'?>
    <?php include 'taxdec_pending/modal.php'?>
    <!------------CONTENT----------->
      <main class="container-fluid">
        <section class="shadow-lg p-3 mb-5 bg-body-tertiary rounded">
          <h2 class="text-center mb-3" style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">PENDING TAX DECLARATION</h2>
          <br>
