...
<main class="mx-auto" size="Letter" style="font-size:16px;">
    ...
    <hr>
    <h2 class="text-center" style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">DAILY COLLECTION RCD</h2>
    <br>
    <div class="row">
        <div class="col">
    ...
    <table class="table table-bordered table-stripped mb-5" id="daily_table" style="width:100%;">
        <thead>
            <tr>
                ...
                <th>DATE PAID</th>
                <th>PAYOR</th>
                <th class="text-center" width="20%">NGAS CODE</th>
                <th class="text-center">NATURE<br>COLLECTION</th>
