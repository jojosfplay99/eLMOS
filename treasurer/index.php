      ...
      <section class="shadow-lg p-3 mb-5 bg-body-tertiary rounded">
        <div class="row g-2">
          <div class="col-7">
            ...
            <button id="pay" class="btn btn-success"><i class="fa-solid fa-backward"></i> RETURN </button> 
            <button id="next" class="btn btn-primary"><i class="fa-solid fa-forward"></i> NEXT SERVE</button> 
